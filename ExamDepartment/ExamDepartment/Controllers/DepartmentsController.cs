...
namespace ExamDepartment.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(ExamDepartmentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            var departments = await _context.Department
                .Select(d => new Department
                {
                    ...
                    NumberOfEmployees = _context.Employee.Count(e => e.DepartmentId == d.DepartmentId)
                })
                .ToListAsync();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ExamDepartmentContext.Department'  is null.");
            }
            var department = await _context.Department.FindAsync(id);
            if (department != null)
            {
