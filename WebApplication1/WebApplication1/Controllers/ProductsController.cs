...
namespace WebApplication1.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Thumbnail,ProductName,Description,Price,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Thumbnail,ProductName,Description,Price,CategoryId")] Product product)
        {
